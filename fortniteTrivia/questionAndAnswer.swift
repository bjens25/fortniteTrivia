...
class questionAndAnswer: NSObject
{
    ...
    var battleQuestions = ["Name a close range weapon","Name a sniper","What does more damage: Bolt or Semi?","How much shield does a Mini Potion give you?","What is the max health that you can get with Bandages?"]
